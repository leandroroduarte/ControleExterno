<?php
// cadastro_cliente.php - Cadastro de novo cliente
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $stmt = $pdo->prepare('INSERT INTO Clientes (nome, email, telefone, cpf_cnpj, cep, endereco, numero, complemento, bairro, cidade, estado, user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
...
<head>
  ...
  <title>Cadastrar Cliente - ControleExterno</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
    ...
    <div class="form-card">
      ...
      <?php if ($success): ?>
        <div class="success">
          ...
          <br><br>
          <a href="clientes.php" style="color: #667eea; font-weight: 600;">Ver lista de clientes</a>
        </div>
      <?php endif; ?>
      ...
      <form method="POST">
        ...
        <div class="form-group">
          ...
          <div style="display: flex; gap: 10px;">
            <input type="text" id="cep" name="cep" maxlength="10" placeholder="00000-000" value="<?php echo htmlspecialchars($cep ?? ''); ?>" style="flex: 1;" inputmode="numeric">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" id="numero" name="numero" maxlength="10" value="<?php echo htmlspecialchars($numero ?? ''); ?>">
          </div>
          <div class="form-group">
            <label for="complemento">Complemento</label>
            <input type="text" id="complemento" name="complemento" maxlength="255" value="<?php echo htmlspecialchars($complemento ?? ''); ?>">
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" id="bairro" name="bairro" maxlength="100" value="<?php echo htmlspecialchars($bairro ?? ''); ?>">
          </div>
          <div class="form-group">
            <label for="cidade">Cidade</label>
            <input type="text" id="cidade" name="cidade" maxlength="100" value="<?php echo htmlspecialchars($cidade ?? ''); ?>">
          </div>
        </div>
  ...
  <script>
    ...
    cepEl && cepEl.addEventListener('keypress', function(e) {
      if (e.key === 'Enter') { e.preventDefault(); document.getElementById('btn-buscar-cep').click(); }
    });
    ...
    document.querySelector('form').addEventListener('submit', function (e) {
      ...
      // opcional: checar formato básico
